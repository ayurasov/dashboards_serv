...
METRIC_DEFS = [
    ...
    ("offers_accepted_pct", "Принятые офферы", "%", "hiring", "numeric", "avg", "higher_is_better", "Доля принятых офферов от выставленных", 50),
    ...
    ("probation_pass_rate", "Процент прохождения ИС (общий)", "%", "adaptation", "numeric", "avg", "higher_is_better", "Доля сотрудников, прошедших испытательный срок", 110),
